...
//        #endif
    ...
    private func launchInterface() {
        ...
        window.contentAspectRatio = NSMakeSize(16, 10)
        
        if CherrygramConfiguration.shared.isWindowBlurEnabled {
            ...
            visualEffect.state = CherrygramConfiguration.shared.isWindowBlurEnabled ? .active : .inactive
